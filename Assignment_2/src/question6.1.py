...
sky = cv.imread('D:/DIP/Assignment_2/a2_2019701006/input_data/sky.png')
noir = cv.imread('D:/DIP/Assignment_2/a2_2019701006/input_data/noir.png')
filtered_image_Sky = apply_bilateral_filter(sky, 5, 24.0, 28.0)
cv.imshow("SKY.png", filtered_image_Sky)

filtered_image_noir = apply_bilateral_filter(noir, 5, 24.0, 28.0)
